...
frame_number = 0
clicked_points = []  # Store clicked points (Frame, X, Y, Action)
...
if uploaded_file:
    ...
    with col1:
        if st.button("⬅️ Previous Frame") and frame_number > 0:
            frame_number -= 1
    with col2:
        if st.button("➡️ Next Frame") and frame_number < total_frames - 1:
            frame_number += 1
